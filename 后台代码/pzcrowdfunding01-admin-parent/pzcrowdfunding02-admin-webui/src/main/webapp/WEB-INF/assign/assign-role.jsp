        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    <form action="assign/save/relationship.html" method="post" role="form" class="form-inline">
                        ...
                        <div class="form-group" style="margin-left:40px;">
                            <%--@declare id="exampleinputpassword2"--%><label for="exampleInputPassword2">已分配角色列表</label><br>
